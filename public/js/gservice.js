...
angular.module('gservice', [])
    .factory('gservice', function($rootScope, $http){
        ...
        var selectedLat = -5.862;
        //var selectedLong = -98.35;
        var selectedLong = -35.204;
        ...
        var convertToMapPoints = function(response){
            ...
            for(var i= 0; i < response.length; i++) {
                ...
                var  contentString = '<p><b>Usuário</b>: ' + user.username + '<br><b>Animal</b>: ' + user.favlang + '<br>' +
                    '<b>Gênero</b>: ' + user.gender + '<br><b>Idade</b>: ' + user.age + '</p>';
